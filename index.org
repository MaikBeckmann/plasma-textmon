...
#+begin_src js
  var sink = {
    dataUpdated: function (name, data) {
      ...
      for(var k in date) {
        print("key : " + k);
        print('typeof date[key] : ' + typeof date[k]);
        print('date[key] : ' + date[k]);
      }
      print('</properties of data["DateTime"]');
    }
  };
...
#+begin_src js
  var sink = {
    dataUpdated: function (name, data) {
      print("==== data =====");
      var date = data["DateTime"]
      print("typeof date : " + typeof date);
      print("typeof date.toString : " + typeof date.toString);
      print("typeof date.toString() : " + typeof date.toString());
...
#+end_src
 ...
 : date.toString() : Sun Feb 12 2012 11:16:58 GMT+0100 (CET)
